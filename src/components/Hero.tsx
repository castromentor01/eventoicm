...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      className="min-h-screen relative flex items-center bg-navy-900 overflow-hidden"
      style={{
        backgroundImage: 'linear-gradient(135deg, rgba(0,6,40,0.97) 0%, rgba(9,25,64,0.97) 100%)',
      }}
    >
      {/* Background texture */}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-12 bg-navy-800/60 py-3 px-6 rounded-full backdrop-blur-sm">
            <p className="text-gray-300 flex items-center">
              ...
              <span>+80 pessoas já confirmaram presença</span>
            </p>
          </div>
        </div>
      </div>
